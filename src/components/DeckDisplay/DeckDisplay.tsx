import { For, Suspense, Switch, Match } from "solid-js";
...
const DeckDisplay: Component<DeckDisplayProps> = (props) => {
  return (
    <div class="m-5 bg-gray-800 flex justify-between p-5 overflow-x-auto">
      <For each={props.deck}>
        {(trainer, i) => (
          <>
            <Suspense
            ...
            >
              <Switch>
                ...
                <Match when={trainer !== "empty"}>
                  <Trainer
                    {...trainersObject[trainer]}
                    src={trainerImages[trainer]}
                    onClickAvatar={() => props.removeTrainer(trainer)}
