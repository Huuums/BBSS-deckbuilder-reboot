...
const Modal: ParentComponent<ModalProps> = (props) => {
  ...
  return (
    <Show when={props.isOpen}>
      <Portal>
        <div class="h-screen w-screen fixed top-0 left-0 right-0 bottom-0 bg-gray-600 bg-opacity-75 z-10" />
        <div class="absolute left-0 right-0 top-0 bottom-0 flex justify-center items-center z-20">
          <div
            ...
            class={classNames(
              "flex-1 max-w-sm px-4 m-auto sm:px-0 lg:max-w-3xl bg-gray-800 relative"
            )}
          >
